...
class News extends Model
{
    ...
    //ニュースの取得
    public static function fetchNews($keyword = null, $pageSize = 5, $page = 1)
    {
        $url = 'https://newsapi.org/v2/top-headlines?country=us&apiKey=' . config('services.newsapi.key');
        ...
        if ($keyword) {
            $url .= '&q=' . urlencode($keyword) . '&pageSize=5';
        }
        // dd($url);
